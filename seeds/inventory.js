  ...
  return knex('inventory').del()
    .then(function () {
      ...
      return knex('inventory').insert([
        {ID: 1, TITLE: 'Climbing Shoes', DESCRIPTION: 'La Sportiva Climbing Shoes', IMAGE: 'https://www.rei.com/media/product/896622', PRICE: 99.50},
        {ID: 2, TITLE: 'Harness', DESCRIPTION: 'Black Diamond Mens Harness', IMAGE: 'https://www.rei.com/media/product/880933', PRICE: 50.00},
